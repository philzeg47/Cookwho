...
- **[Low → story 3.4]** `monAcces` ne renvoie pas `statut` ; nécessaire pour accueillir un participant déjà REPONDU (« On a déjà tes préférences ✓ »). Déjà dans le périmètre de 3.4.
